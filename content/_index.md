...
My working days are mostly spent sitting, reading, writing, thinking and discussing ideas. I try to balance this with **running**, conscious **breathing** and **stretching**. Again, for its holistic approach, I like the concept of [chi running](https://www.runwithconstanza.com/) which incorporates the principles of [Tai Chi](https://en.wikipedia.org/wiki/Tai_chi) into running. It also provides a lot of inspiration for my daily work. As in agile and devops, it's all about alignment (of feet, legs, upper body, arms and head), sensing (of body signals) and adaptation (of posture and running form), sustainable rhythm and flow.
